...
class ResNet(nn.Module):
    def __init__(self):
        ...
        enc_dim = 128
        self.conv1 = nn.Conv2d(3+24+3,enc_dim,kernel_size=7,stride=2,padding=3)
...
class SlotAttEncoder(nn.Module):
    def __init__(self):
        super(SlotAttEncoder,self).__init__()
        hid_dim = 128
        self.conv1 = nn.Conv2d(3+24+3, hid_dim, 5, padding = 2)

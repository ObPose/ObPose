...
class Nerf(nn.Module):
    def __init__(self,cam_proj,device):
    ...
    def forward(self,p_surface,num_surface,ray,p_air,num_air,z_what,bb_loc,bb_rot_matrix,depth,obj_size):
        ...
        with torch.no_grad():
            ...
            p_voxel_cam = self.cam_proj[None,None,None]@torch.cat([p_voxel_world,torch.ones([B,K,self.cell_num**3,1],device=self.device)],dim=3)[:,:,:,:,None]
            #p_voxel_cam: BxKxcnxcnxcn-3-1
